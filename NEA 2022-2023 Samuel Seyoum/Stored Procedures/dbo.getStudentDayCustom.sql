CREATE PROCEDURE [dbo].[getStudentDayCustom]
	@Username varchar(9),
	@sDate date,
	@eDate date
AS
	...
	WHERE tblCustomFood.CFoodID = tblFoodEntry.FoodID AND tblFoodEntry.Username = @Username AND tblCustomFood.Username = @Username AND tblFoodEntry.Custom = 1 AND tblFoodEntry.Date BETWEEN @sDate AND @eDate
RETURN 0